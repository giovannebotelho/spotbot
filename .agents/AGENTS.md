...
## 🇧🇷 IDIOMA E COMUNICAÇÃO OFICIAL
- **Linguagem Padrão**: Todas as respostas, explicações, planos de implementação e relatórios DEVEM ser redigidos em **Português do Brasil (pt-BR)**.
