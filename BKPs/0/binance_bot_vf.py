...
async def get_closes(client, symbol, interval='5m', limit=12):
...
async def main():
    ...
    async with bsm.user_socket() as um:
        while True:
            ...
            if await should_place_order(client, symbol):
                ...
                if rsi < 30 or (macd_current > signal_line_current and closes[-1] < lower_band):
                    ...
                    while True:
                        ...
                        if rsi > 70 or (macd_current < signal_line_current and closes[-1] > upper_band):                            
                            print("")
                            print(f"\nRSI is \033[1;31m{rsi:.1f}\033[0m, considering selling. MACD \033[1;31mbelow\033[0m Signal Line, \033[1;31msell\033[0m signal. Bollinger Bands opport. \033[1;31msell\033[0m found.\n")
            ...
            await asyncio.sleep(1.5)  # Short pause before checking for new orders or balance updates
