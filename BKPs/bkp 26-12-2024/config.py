...
short_period = 8  # Período curto para cálculos de média móvel em comparações de tendência.
long_period = 18  # Período longo para cálculos de média móvel em comparações de tendência.
...
# is_rsi_low_level0 or (is_rsi_low_level1 and trend_is_up) or (is_rsi_low_level2 and candle_decision == 'buy') or is_macd_bullish
rsi_low_level_0 = 18  # Limiar para o RSI considerado muito baixo.
rsi_low_level_1 = 25  # Limiar superior para RSI considerando tendências de alta.
rsi_low_level_2 = 30  # Limiar mais alto para RSI em decisões de compra com base em padrões de candle.
rsi_low_level_3 = 35 # Limiar ainda mais alto para RSI em decisões de compra com base em padrões de candle e tendências de alta.
...
#else:
lucro_multiplier_2 = 1.0035  # Multiplicador de lucro para preços maiores ou iguais a 1.
stop_loss_multiplier_2 = 0.997  # Multiplicador de stop loss para preços maiores ou iguais a 1.
